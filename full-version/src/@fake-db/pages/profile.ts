...
const data: DataType = {
  ...
  profile: {
    about: [
      { property: 'Full Name', value: '월/수반 오후 5시', icon: 'mdi-account-outline' },
      { property: 'Status', value: 'active', icon: 'mdi-check' },
      { property: '대상', value: '초등 5학년', icon: 'mdi-star-outline' },
      { property: '교재', value: '수능특강', icon: 'mdi-flag-outline' },
      { property: '단어장', value: '토익 영단어 300day', icon: 'mdi-translate' },
    ],
    contacts: [
    ...
    teams: [
      { property: '참여 학생', value: '(5 Members)', icon: 'mdi-github', color: 'primary' },
    ],
    overview: [
      { property: '수업 일 수', value: '5회 / 8회', icon: 'mdi-check' },
      { property: '과제 참여율', value: '56%', icon: 'mdi-account-outline' },
      { property: '단어시험 통과율', value: '70%', icon: 'mdi-view-grid-plus-outline' },
    ],
    connections: [
      {
        isFriend: false,
